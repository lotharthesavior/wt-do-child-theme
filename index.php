	...
	<div id="content-wrap" class="container clr">
		...
		<div id="primary" class="content-area clr">
			...
			<div id="content" class="site-content clr">
                ...
                <?php
                // Dependency: Slide Anything (Plugin)
                // TODO: add the posts here as a shortcode to the theme and
                //       call it in a commong page to leave this page not touched
                echo do_shortcode("[slide-anything id=\"374\"]"); ?>
